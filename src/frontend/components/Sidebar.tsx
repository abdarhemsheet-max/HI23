...
const NAV = [
  ...
  { href: '/works', label: 'معرض أعمالي', short: 'المعرض', icon: LayoutGrid },
        ...
        <div className="glass flex h-full flex-col p-4">
            ...
            {NAV.map(({ href, label, icon: Icon }) => (
              <Link
                ...
                className={cn(
                  ...
                  isActive(href)
                    ? 'bg-gradient-to-l from-orange-500/20 to-transparent text-orange-300 border border-orange-500/20'
          ...
          <div className="mt-4">
            ...
            <button
              ...
              className="mb-2 flex w-full items-center justify-center gap-2 rounded-xl border border-white/[0.07] bg-white/[0.03] px-3 py-2 text-[11px] font-bold text-slate-400 transition hover:border-orange-500/25 hover:text-orange-300"
            >
        ...
        {NAV.map(({ href, short, icon: Icon }) => (
          <Link
            ...
            className={cn(
              ...
              isActive(href) ? 'text-orange-300' : 'text-slate-500'
            )}
          >
            <Icon size={18} />
            {short}
